...
const TESTIMONIALS = [
  {
    ...
    quote: "We were losing 30+ calls a week to voicemail. Raf built an automated intake system that captures every lead and books estimates on the spot. Revenue is up 40% and I actually sleep at night now.",
    metric: '+40% revenue',
  },
  {
    name: 'Dr. Amara Osei',
    company: 'Restore Wellness Collective',
    role: 'Founder',
    location: 'Atlanta, GA',
    industry: 'Health & Wellness',
    quote: "I was drowning in admin. Scheduling, follow-ups, intake forms. Raf automated the entire patient journey. I went from 20 hours of admin per week to basically zero.",
    metric: '20hrs saved/week',
  },
  {
    name: 'Robert Castellano',
    company: 'Castellano Law Group',
    role: 'Managing Partner',
    location: 'Chicago, IL',
    industry: 'Professional Services',
    quote: "We thought we needed two more paralegals. Turns out we needed better systems. Raf streamlined our client intake, document collection, and case updates. Saved us $120K in hiring costs.",
    metric: '$120K saved',
  },
  {
    name: 'Maria Delgado',
    ...
    location: 'Phoenix, AZ',
    industry: 'Home Services',
    quote: "Our quoting process used to take 3 days. Now it takes 3 minutes. Clients are blown away by how fast we respond. We close twice as many jobs and our reviews went from 3.8 to 4.9 stars.",
    metric: '2x close rate',
  },
  {
    name: 'Dr. Jason Park',
    company: 'Summit Chiropractic & Sports',
    role: 'Clinic Director',
    location: 'Denver, CO',
    industry: 'Health & Wellness',
    quote: "Raf didn't just fix our marketing. He re-engineered how our entire practice operates. Patient retention is up 60%, no-shows dropped by half, and I finally have my evenings back.",
    metric: '+60% retention',
  },
  {
    name: 'Linda Cho',
    company: 'Cho & Associates CPA',
    role: 'Senior Partner',
    location: 'Seattle, WA',
    industry: 'Professional Services',
    quote: "Tax season used to be pure chaos. Now client intake, document requests, and follow-ups all run on autopilot. Our team handles 35% more clients with the same headcount.",
    metric: '+35% capacity',
  },
]
